...
import { Mic, MicOff, Volume2, VolumeX, CheckCircle, AlertCircle, Loader2, Brain, Globe } from "lucide-react"
...
export default function AIFormFillerImproved({ formId, onComplete, onBack }: AIFormFillerProps) {
  const { user } = useAuth()
